...
// Common Helpers
[@bs.module "date-fns/closestIndexTo"] external closestIndexTo: (Js.Date.t, array(Js.Date.t)) => int = "default";
[@bs.module "date-fns/closestTo"] external closestTo: (Js.Date.t, array(Js.Date.t)) => Js.Date.t = "default";
...
[@bs.module "date-fns/formatDistance"] external formatDistanceOpt: (Js.Date.t, Js.Date.t, formatDistanceOptions) => string = "default";
[@bs.module "date-fns/formatDistanceStrict"] external formatDistanceStrict: (Js.Date.t, Js.Date.t) => string = "default";
...
[@bs.module "date-fns/formatDistanceStrict"] external formatDistanceStrictOpt: (Js.Date.t, Js.Date.t, formatDistanceStrictOptions) => string = "default";
...
[@bs.module "date-fns/formatDistanceToNow"] external formatDistanceToNowOpt: (Js.Date.t, formatDistanceToNowOptions) => string = "default";
...
[@bs.module "date-fns/formatRFC3339"] external formatRFC3339Options: (Js.Date.t, formatRFC3339Options) => string = "default";
...
[@bs.module "date-fns/formatRelative"] external formatRelativeOpt: (Js.Date.t, Js.Date.t, formatRelativeOptions) => string = "default";
...
[@bs.module "date-fns/parse"] external parseOpt: (string, string, Js.Date.t, parseOptions) => Js.Date.t = "default";
...
// Interval Helpers
[@bs.module "date-fns/areIntervalsOverlapping"] external areIntervalsOverlapping: (Js.Date.t, Js.Date.t) => bool = "default";
[@bs.module "date-fns/eachDayOfInterval"] external eachDayOfInterval: interval => array(Js.Date.t) = "default";
type eachDayOfIntervalOptions = {step: option(int)};
[@bs.module "date-fns/eachDayOfInterval"] external eachDayOfIntervalOpt: (interval, eachDayOfIntervalOptions) => array(Js.Date.t) = "default";
[@bs.module "date-fns/eachWeekOfInterval"] external eachWeekOfInterval: interval => array(Js.Date.t) = "default";
type eachWeekOfIntervalOptions = {
  locale: option(locale),
  weekStartsOn: option(int),
};
[@bs.module "date-fns/eachWeekOfInterval"] external eachWeekOfIntervalOpt: (interval, eachWeekOfIntervalOptions) => array(Js.Date.t) = "default";
[@bs.module "date-fns/eachWeekendOfInterval"] external eachWeekendOfInterval: interval => array(Js.Date.t) = "default";
[@bs.module "date-fns/getOverlappingDaysInIntervals"] external getOverlappingDaysInIntervals: (interval, interval) => int = "default";
[@bs.module "date-fns/getOverlappingDaysInIntervals"] external getOverlappingDaysInIntervalsf: (interval, interval) => float = "default";
[@bs.module "date-fns/isWithinInterval"] external isWithinInterval: (Js.Date.t, interval) => bool = "default";
...
[@bs.module "date-fns/addMilliseconds"] external addMillisecondsf: (Js.Date.t, float) => Js.Date.t = "default";
[@bs.module "date-fns/differenceInMilliseconds"] external differenceInMilliseconds: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInMilliseconds"] external differenceInMillisecondsf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/setMilliseconds"] external setMillisecondsf: (Js.Date.t, float) => Js.Date.t = "default";
[@bs.module "date-fns/subMilliseconds"] external subMilliseconds: (Js.Date.t, int) => Js.Date.t = "default";
[@bs.module "date-fns/subMilliseconds"] external subMillisecondsf: (Js.Date.t, float) => Js.Date.t = "default";
...
[@bs.module "date-fns/differenceInSeconds"] external differenceInSeconds: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInSeconds"] external differenceInSecondsf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/differenceInMinutes"] external differenceInMinutes: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInMinutes"] external differenceInMinutesf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/roundToNearestMinutes"] external roundToNearestMinutes: Js.Date.t => Js.Date.t = "default";
type roundToNearestMinutesOptions = {nearestTo: option(int)};
[@bs.module "date-fns/roundToNearestMinutes"] external roundToNearestMinutesOpt: (Js.Date.t, roundToNearestMinutesOptions) => Js.Date.t = "default";
...
[@bs.module "date-fns/differenceInHours"] external differenceInHours: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInHours"] external differenceInHoursf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/addBusinessDays"] external addBusinessDaysf: (Js.Date.t, float) => Js.Date.t = "default";
...
[@bs.module "date-fns/differenceInBusinessDays"] external differenceInBusinessDays: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInBusinessDays"] external differenceInBusinessDaysf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInCalendarDays"] external differenceInCalendarDays: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarDays"] external differenceInCalendarDaysf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInDays"] external differenceInDays: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInDays"] external differenceInDaysf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/subBusinessDays"] external subBusinessDaysf: (Js.Date.t, float) => Js.Date.t = "default";
...
[@bs.module "date-fns/setDay"] external setDayOptf: (Js.Date.t, float, setDayOptions) => Js.Date.t = "default";
...
[@bs.module "date-fns/differenceInCalendarWeeks"] external differenceInCalendarWeeks: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarWeeks"] external differenceInCalendarWeeksOpt: (Js.Date.t, Js.Date.t, weekOptions) => int = "default";
[@bs.module "date-fns/differenceInCalendarWeeks"] external differenceInCalendarWeeksf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInCalendarWeeks"] external differenceInCalendarWeeksOptf: (Js.Date.t, Js.Date.t, weekOptions) => float = "default";
[@bs.module "date-fns/differenceInWeeks"] external differenceInWeeks: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInWeeks"] external differenceInWeeksf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/getWeekOfMonth"] external getWeekOfMonthOpt: (Js.Date.t, weekOptions) => int = "default";
[@bs.module "date-fns/getWeekOfMonth"] external getWeekOfMonthOptf: (Js.Date.t, weekOptions) => float = "default";
...
[@bs.module "date-fns/getWeeksInMonth"] external getWeeksInMonthOpt: (Js.Date.t, weekOptions) => int = "default";
[@bs.module "date-fns/getWeeksInMonth"] external getWeeksInMonthOptf: (Js.Date.t, weekOptions) => float = "default";
[@bs.module "date-fns/isSameWeek"] external isSameWeek: (Js.Date.t, Js.Date.t) => bool = "default";
[@bs.module "date-fns/isSameWeek"] external isSameWeekOpt: (Js.Date.t, Js.Date.t, weekOptions) => bool = "default";
...
[@bs.module "date-fns/setWeek"] external setWeekOpt: (Js.Date.t, int, setWeekOptions) => Js.Date.t = "default";
[@bs.module "date-fns/setWeek"] external setWeekOptf: (Js.Date.t, float, setWeekOptions) => Js.Date.t = "default";
[@bs.module "date-fns/startOfWeek"] external startOfWeek: Js.Date.t => Js.Date.t = "default";
[@bs.module "date-fns/startOfWeek"] external startOfWeekOpt: (Js.Date.t, weekOptions) => Js.Date.t = "default";
...
// ISO Week Helpers
[@bs.module "date-fns/differenceInCalendarISOWeeks"] external differenceInCalendarISOWeeks: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarISOWeeks"] external differenceInCalendarISOWeeksf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/differenceInCalendarMonths"] external differenceInCalendarMonths: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarMonths"] external differenceInCalendarMonthsf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInMonths"] external differenceInMonths: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInMonths"] external differenceInMonthsf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/eachWeekendOfMonth"] external eachWeekendOfMonth: Js.Date.t => array(Js.Date.t) = "default";
...
[@bs.module "date-fns/differenceInCalendarQuarters"] external differenceInCalendarQuarters: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarQuarters"] external differenceInCalendarQuartersf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInQuarters"] external differenceInQuarters: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInQuarters"] external differenceInQuartersf: (Js.Date.t, Js.Date.t) => float = "default";
...
external lastDayOfQuarterOpt: (Js.Date.t, lastDayOfQuarterOptions) => Js.Date.t = "date-fns/lastDayOfQuarter";
...
[@bs.module "date-fns/differenceInCalendarYears"] external differenceInCalendarYears: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarYears"] external differenceInCalendarYearsf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInYears"] external differenceInYears: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInYears"] external differenceInYearsf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/eachWeekendOfYear"] external eachWeekendOfYear: Js.Date.t => array(Js.Date.t) = "default";
...
[@bs.module "date-fns/addISOWeekYears"] external addISOWeekYearsf: (Js.Date.t, float) => Js.Date.t = "default";
[@bs.module "date-fns/differenceInCalendarISOWeekYears"] external differenceInCalendarISOWeekYears: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInCalendarISOWeekYears"] external differenceInCalendarISOWeekYearsf: (Js.Date.t, Js.Date.t) => float = "default";
[@bs.module "date-fns/differenceInISOWeekYears"] external differenceInISOWeekYears: (Js.Date.t, Js.Date.t) => int = "default";
[@bs.module "date-fns/differenceInISOWeekYears"] external differenceInISOWeekYearsf: (Js.Date.t, Js.Date.t) => float = "default";
...
[@bs.module "date-fns/isSameISOWeekYear"] external isSameISOWeekYear: (Js.Date.t, Js.Date.t) => bool = "default";
[@bs.module "date-fns/lastDayOfISOWeekYear"] external lastDayOfISOWeekYear: Js.Date.t => Js.Date.t = "default";
...
[@bs.module "date-fns/subISOWeekYears"] external subISOWeekYearsf: (Js.Date.t, float) => Js.Date.t = "default";
...
[@bs.module "date-fns/endOfDecade"] external endOfDecadeOpt: (Js.Date.t, endOfDecadeOptions) => Js.Date.t = "default";
...
[@bs.module "date-fns/getWeekYear"] external getWeekYearOptf: (Js.Date.t, weekYearOptions) => float = "default";
[@bs.module "date-fns/setWeekYear"] external setWeekYear: (Js.Date.t, int) => Js.Date.t = "default";
[@bs.module "date-fns/setWeekYear"] external setWeekYearOpt: (Js.Date.t, int, weekYearOptions) => Js.Date.t = "default";
[@bs.module "date-fns/setWeekYear"] external setWeekYearf: (Js.Date.t, float) => Js.Date.t = "default";
[@bs.module "date-fns/setWeekYear"] external setWeekYearOptf: (Js.Date.t, float, weekYearOptions) => Js.Date.t = "default";
[@bs.module "date-fns/startOfWeekYear"] external startOfWeekYear: Js.Date.t => Js.Date.t = "default";
[@bs.module "date-fns/startOfWeekYear"] external startOfWeekYearOpt: (Js.Date.t, weekYearOptions) => Js.Date.t = "default";
